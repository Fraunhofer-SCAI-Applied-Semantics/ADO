 ...
 * [ado.yml](ado.yml)
     * Determines how your purl.obolibrary.org/obo/ado/ redirects will be handled
     ...
     * Paste in the contents of [ado.yml](ado.yml)
 ...
 * [ado.md](ado.md)
     ...
     * Paste in the contents of [ado.md](ado.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
